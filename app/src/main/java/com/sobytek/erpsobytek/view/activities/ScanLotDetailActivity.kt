...
class ScanLotDetailActivity : BaseActivity(), ZXingScannerView.ResultHandler  {

    private lateinit var context: Context
    private lateinit var binding:ActivityScanLotDetailBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityScanLotDetailBinding.inflate(layoutInflater)
    ...
    private fun setUpToolbar() {
        ...
        if (supportActionBar != null) {
            supportActionBar!!.title = "Scan Lot Detail"
...
//            }
            ...
            showAlert(context,"Scanned text not a EmployeeId", object : DialogInterface.OnClickListener{
                override fun onClick(dialog: DialogInterface?, which: Int) {
                    dialog!!.dismiss()
                    binding.scanner.resumeCameraPreview(this@ScanLotDetailActivity)
                    binding.scanner.startCamera()
                }
