...
class IGPActivityViewModel : ViewModel() {
    ...
    fun callIgp(context: Context, gir_id: String,user_id: String,passo: String) {
        ipgResponse = ApiRepository.getInstance(context).igp(gir_id,user_id,passo)
    }
    ...
    fun callIgpIssue(context: Context,worker_id:Int,user_id:String,passo: String,gir_id: String,gir_year: String,op_no:Int){
        igpIssueResponse = ApiRepository.getInstance(context).igpIssue(worker_id,user_id,passo,gir_id,gir_year,op_no)
    }
    ...
    fun callIgpReceive(context: Context,gir_id:String,rec_qty:Int,user_id: String,passo: String,rej_qty:Int,op_no:Int,remarks:String){
        igpReceiveResponse = ApiRepository.getInstance(context).igpReceive(gir_id,rec_qty,user_id,passo,rej_qty,op_no,remarks)
    }
